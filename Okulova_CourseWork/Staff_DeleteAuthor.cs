...
{
    public partial class Staff_DeleteAuthor : Form
    {
        private DB db = new DB();
        public Staff_DeleteAuthor()
        {
            InitializeComponent();
        ...
        private void Deletebutton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (a == 0)
                {
                    var query = from b in db.GetAuthorsTable()
                    ...
                    {
                        if (MessageBox.Show("Вы уверены, что хотите удалить все сведения об авторе?", "",
